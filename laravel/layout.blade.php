...
<script>
	...
	<div id="social-links">
		<ul id="shortlinks">
		<li><a href="http://www.dilma.com.br/" target="_new">{{HTML::image("assets/img/logo-dilma-39.png","",array("class"=>"img-responsive","style"=>"padding-top:3px;"))}}</a></li>
	...
	<section class="container">	
		...
		<footer>
			...
			<div class="row footer copyright">
				<p style="text-align:center;margin-top:5px;padding:0 40px;">Rua General Bittencourt, 170 - Osasco - SP - CEP: 06016-040  -  (011) 36852164

...
@section("maincontent")
    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Ingresar arquivo</h3>
                        </div>
                                    ...
                                    <div class="form-group col-md-7 col-sm-7 col-xs-7">
                                        ...
                                        <div class="row">
                                            ...
                                            <span class="btn btn-success fileinput-button">
                                                    ...
                                                    <span>Incluir...</span>
                                                    <input type="file" id="archivo" name="archivo" class="form-control" value="">
                                                    </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-5 col-sm-5 col-xs-5">
                                        <div class="row">
                                            <div class="form-group col-md-4 col-sm-4 col-xs-4">
                                                ...
                                                <span class="tips"></span>
                                                <div class="controls">
                                                   <input id="status" name="status" data-on-color="info" data-on-text="SIM" data-off-text="NÃO" data-off-color="danger" type="checkbox" class="switch" <?php echo $information->status == 1 ? 'checked' : '' ?>>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            @if($information->mainImage != '')
                                                    <div class="controls">
                                                        ...
                                                        <i class="glyphicon glyphicon-plus"></i>
                                                        <span>Trocar </span>
                                                        <input type="file" name="destaque" value="">
                                                        </span>

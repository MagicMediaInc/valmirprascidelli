...
@section("maincontent")
                                                <?php
                                                    ...
                                                    foreach($pages as $page):
                                                        if($information->idPage==$page->id):
                                                            $pagina=$page->description; 
                                                        endif;
                                                    endforeach;
                                                    ?>
	<div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Incluir {{$pagina}} </h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                {{Form::hidden('content', '' ,array('style'=>'display:none;','value'=>$information->content))}}
                                    <div class="form-group col-md-7 col-sm-7 col-xs-7">
                                        <div class="row">
                                            <label class="form-label"><strong>Titulo</strong></label>
                                            <span class="tips"></span>
                                            <div class="controls">
                                                {{ Form::text('title', $information->title, array('id'=>'title', "class"=>"form-control"  )) }}
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <span class="tips"></span>
                                            <div class="controls">
                                                {{ Form::text('description', $information->description, array('id'=>'description', "class"=>"form-control" )) }}
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="form-group col-md-5 col-sm-5 col-xs-5">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                                <label class="form-label col-md-6 col-sm-6 col-xs-6"><strong>Img. Destaque</strong></label>
                                                <span class="tips"></span>
                                                @if($information->mainImage != '')
                                                    <div class="controls col-md-6 col-sm-6 col-xs-6">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                                        <img src="{{ $information->mainImage }}" width="150px">
                                                    </div>
                                                @else
                                                    <div class="controls">
                                                        <span class="btn btn-success fileinput-button">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    endforeach;
                                                    ?>
                                                    {{ Form::select('idPage', $arr, $information->idPage) }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>

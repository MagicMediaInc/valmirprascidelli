                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="withScroll" data-height="320">
                        <a href="#" class="message-item media">
                          <div class="media">
                            <img src="assets/admin/assets/img/avatars/avatar1.png" alt="avatar 1" width="40" class="pull-left">
                        ...
                        <a href="#" class="message-item media">
                          <div class="media">
                            <img src="assets/admin/assets/img/avatars/avatar2.png" alt="avatar 2" width="40" class="pull-left">
                            <div class="media-body">
                              <div class="pull-left">
                        ...
                        <a href="#" class="message-item media">
                          <div class="media">
                            <img src="assets/admin/assets/img/avatars/avatar3.png" alt="avatar 3" width="40" class="pull-left">
                            <div class="media-body">
                              <div class="pull-left">
                                <p class="c-dark m-0"><strong>John Snow</strong></p>
                                <p class="c-gray m-0">cameso@it.com</p>
                        ...
                        <a href="#" class="message-item media">
                          <div class="media">
                            <img src="assets/admin/assets/img/avatars/avatar4.png" alt="avatar 4" width="40" class="pull-left">
                            <div class="media-body">
                              <div class="pull-left">
                                <p class="c-dark m-0"><strong>Jerry Smith</strong></p>
                                <p class="c-gray m-0">bugomi@vigu.com</p>
                        ...
                        <a href="#" class="message-item media">
                          <div class="media">
                            <img src="assets/admin/assets/img/avatars/avatar5.png" alt="avatar 5" width="40" class="pull-left">
                            <div class="media-body">
                              <div class="pull-left">
                                <p class="c-dark m-0"><strong>John Snow</strong></p>
                                <p class="c-gray m-0">cameso@it.com</p>
                        ...
                        <a href="#" class="message-item media">
                          <div class="media">
                            <img src="assets/admin/assets/img/avatars/avatar6.png" alt="avatar 6" width="40" class="pull-left">
                            <div class="media-body">
                              <div class="pull-left">
                                <p class="c-dark m-0"><strong>Jerry Smith</strong></p>
                                <p class="c-gray m-0">bugomi@vigu.com</p>
                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="withScroll" data-height="480">
                        <a href="#" class="message-item media">
                          <div class="media">
                            <img src="assets/admin/assets/img/avatars/avatar13.png" alt="avatar 13" width="50" class="pull-left">
                            <div class="media-body">
                        ...
                        <a href="#" class="message-item media">
                          <div class="media">
                            <img src="assets/admin/assets/img/avatars/avatar12.png" alt="avatar 12" width="50" class="pull-left">
                            <div class="media-body">
                              <small class="pull-right">23 Sept</small>
                        ...
                        <a href="#" class="message-item media">
                          <div class="media">
                            <img src="assets/admin/assets/img/avatars/avatar11.png" alt="avatar 11" width="50" class="pull-left">
                            <div class="media-body">
                              <small class="pull-right">23 Sept</small>
                              <h5 class="c-dark"><strong>John Snow</strong></h5>
                              <h4 class="c-dark">Reset your account password</h4>
                        ...
                        <a href="#" class="message-item media">
                          <div class="media">
                            <img src="assets/admin/assets/img/avatars/avatar10.png" alt="avatar 10" width="50" class="pull-left">
                            <div class="media-body">
                              <small class="pull-right">23 Sept</small>
                              <h5 class="c-dark"><strong>Jerry Smith</strong></h5>
                              <h4 class="c-dark">Check Dropbox</h4>
                        ...
                        <a href="#" class="message-item media">
                          <div class="media">
                            <img src="assets/admin/assets/img/avatars/avatar9.png" alt="avatar 9" width="50" class="pull-left">
                            <div class="media-body">
                              <small class="pull-right">23 Sept</small>
                              <h5 class="c-dark"><strong>John Snow</strong></h5>
                              <h4 class="c-dark">Reset your account password</h4>
                        ...
                        <a href="#" class="message-item media"> 
                          <div class="media">
                            <img src="assets/admin/assets/img/avatars/avatar8.png" alt="avatar 8" width="50" class="pull-left">
                            <div class="media-body">
                              <small class="pull-right">23 Sept</small>
                              <h5 class="c-dark"><strong>Jerry Smith</strong></h5>
                              <h4 class="c-dark">Check Dropbox</h4>
                        ...
                        <a href="#" class="message-item media">
                          <div class="media">
                            <img src="assets/admin/assets/img/avatars/avatar7.png" alt="avatar 7" width="50" class="pull-left">
                            <div class="media-body">
                              <small class="pull-right">23 Sept</small>
                              <h5 class="c-dark"><strong>John Snow</strong></h5>
                              <h4 class="c-dark">Reset your account password</h4>
...
@section("plugins")
	{{HTML::script("assets/admin/assets/plugins/metrojs/metrojs.min.js")}}
    {{HTML::script('assets/admin/assets/plugins/fullcalendar/moment.min.js')}}
    {{HTML::script('assets/admin/assets/plugins/fullcalendar/fullcalendar.min.js')}}
   	{{HTML::script("assets/admin/assets/plugins/simple-weather/jquery.simpleWeather.min.js")}}
   	{{HTML::script("assets/admin/assets/plugins/google-maps/markerclusterer.js")}}
    {{HTML::script("http://maps.google.com/maps/api/js?sensor=true")}}
   	{{HTML::script("assets/admin/assets/plugins/google-maps/gmaps.js")}}
   	{{HTML::script("assets/admin/assets/plugins/charts-flot/jquery.flot.js")}}
   	{{HTML::script("assets/admin/assets/plugins/charts-flot/jquery.flot.animator.min.js")}}
   	{{HTML::script("assets/admin/assets/plugins/charts-flot/jquery.flot.resize.js")}}
   	{{HTML::script("assets/admin/assets/plugins/charts-flot/jquery.flot.time.min.js")}}
   	{{HTML::script("assets/admin/assets/plugins/charts-morris/raphael.min.js")}}
   	{{HTML::script("assets/admin/assets/plugins/charts-morris/morris.min.js")}}
   	{{HTML::script("assets/admin/assets/plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js")}}
   	{{HTML::script("assets/admin/assets/js/calendar.js")}}
   	{{HTML::script("assets/admin/assets/js/dashboard.js")}}
@stop